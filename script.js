...
const dictionaries = {
  ro: {
    ...
    login_password_placeholder: "Parola contului",
    username_label: "Username",
    register_name_placeholder: "Nume Prenume",
    register_email_placeholder: "igor",
    register_password_placeholder: "Alege o parola",
    register_password_confirm_placeholder: "Repeta parola",
    ...
    car_statuses: ["Invitat", "Sosit", "Plecat"],
  ...
  ru: {
    ...
    car_statuses: ["Приглашен", "Прибыл", "Ушел"],
  ...
  en: {
    ...
    email_label: "Email",
    login_label: "Login",
    login_email_placeholder: "Enter login or email",
    password_label: "Password",
    login_password_placeholder: "Account password",
    username_label: "Username",
    register_name_placeholder: "Full name",
    register_email_placeholder: "igor",
    register_password_placeholder: "Choose a password",
    register_password_confirm_placeholder: "Repeat password",
    ...
    car_statuses: ["Invited", "Arrived", "Left"],
